...
export function CreateInvoicePage() {
  ...
  const [items, setItems] = useState<ItemRow[]>([
    { product_id: null, description: '', quantity: '1', unit: '', unit_price: '' },
  ])
  ...
  function addItem() {
    setItems([...items, { product_id: null, description: '', quantity: '1', unit: '', unit_price: '' }])
  }
  ...
  function updateItem(index: number, field: keyof ItemRow, value: string) {
    ...
    if (field === 'product_id' && value) {
      ...
      if (product) {
        ...
        updated[index].unit_price = String(product.sell_price)
      }
    }
    setItems(updated)
  }
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Create a new invoice for your customer</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="card" style={{ marginBottom: 24 }}>
          ...
          <div className="text-right mt-4">
            ...
            <div className="text-lg font-bold">{formatCurrency(subtotal, form.currency)}</div>
          </div>
        </div>
