...
export function TransactionsPage() {
  ...
  async function handleAddUnit() {
    ...
    if (!name?.trim()) return
    const { error } = await supabase.from('custom_units').insert({
      user_id: session!.user.id,
      name: name.trim(),
    })
    if (error) {
              ...
              <tbody>
                {filtered.map((t) => (
                  <tr key={t.id}>
                    ...
                    <td className="font-bold" style={{ color: t.type === 'income' ? 'var(--success-600)' : 'var(--error-600)' }}>
              ...
              <div className="modal-body">
                ...
                <div className="form-group">
                  ...
                  <div className="flex gap-2">
                    <button
                      type="button"
                      className={`btn ${form.type === 'income' ? 'btn-success' : 'btn-secondary'}`}
                    ...
                    <button
                      type="button"
                      className={`btn ${form.type === 'expense' ? 'btn-danger' : 'btn-secondary'}`}
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    placeholder="e.g. Sold 5 bottles of water"
                    required
                  />
                </div>
                <div className="form-row">
                  ...
                  <div className="form-group">
                    <label className="form-label">
                      Unit{' '}
                      <button type="button" className="text-sm" style={{ color: 'var(--primary-600)' }} onClick={handleAddUnit}>
                        + Add
                      </button>
                    </label>
                    <select
